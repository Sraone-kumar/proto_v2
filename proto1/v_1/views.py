...
def insert_into_class_time_table(request):
  ...
  # compulsary for queriying...below values.......
    ...
    #if sir_assign(timing,weeday)==true:
    #return...add
    '''funxtion written here'''
...
<<<<<<< HEAD
#sir_assigning(timing,day):
#return true||false
'''function which is written in dragdrop operation is occuring when the option is dropped it should check whether the faculty is allotted any other classes in that period '''
''''''
=======
def login(request):
